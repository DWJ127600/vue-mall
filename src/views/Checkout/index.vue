        ...
        <div class="box-body">
          <div class="address">
            ...
            <div class="action">
              ...
              <el-button size="large" @click="null">添加地址</el-button>
            </div>
          </div>
        </div>
        <!-- 商品信息 -->
...
import useCheckout, { type UserAddress } from '@/composables/useCheckout'
import useOrderId from '@/composables/useOrderId'
import useCartStore from '@/stores/cartStore'
import { ref } from 'vue'
import { useRouter } from 'vue-router'

const { checkInfo, defaultAddress } = useCheckout()
const showDialog = ref(false)
const activeAddress = ref<UserAddress>({} as UserAddress)
...
const { orderId, getOrderId } = useOrderId()
